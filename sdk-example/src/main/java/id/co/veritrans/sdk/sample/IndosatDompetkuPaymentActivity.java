 ...
 */
public class IndosatDompetkuPaymentActivity extends AppCompatActivity implements TransactionBusCallback{
    ProgressDialog dialog;
    private Button buttonPay;
    private String sampleMSISDN = "0812345678";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.title_activity_indosat_dompetku));
