 ...
 */
public class CIMBClickPayPaymentActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.title_activity_cimb_payment));
        ...
        buttonPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.show();
                VeritransSDK.getVeritransSDK().snapPaymentUsingCIMBClick(
    ...
    private void actionTransactionError(Throwable error) {
        dialog.dismiss();
        AlertDialog dialog = new AlertDialog.Builder(CIMBClickPayPaymentActivity.this)
