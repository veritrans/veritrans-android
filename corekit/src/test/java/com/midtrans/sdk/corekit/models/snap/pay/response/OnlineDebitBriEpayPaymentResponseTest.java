...
public class OnlineDebitBriEpayPaymentResponseTest {
    private OnlineDebitBriEpayPaymentResponse response;
    ...
    public void test_setup() {
        ...
        this.response = new OnlineDebitBriEpayPaymentResponse();
    }
