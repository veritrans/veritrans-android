...
public class BcaKlikpayActivity extends BaseActivity implements BcaKlikpayView {
    ...
    private void initToolbar() {
        // Set title
        setHeaderTitle(getString(R.string.bca_klik));
    ...
    @Override
    public void onBcaKlikpayFailure(String message) {
        dismissProgressDialog();
