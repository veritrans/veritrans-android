...
public class TransactionResponseTest {
    ...
    public void transactionIdTest(){
        ...
        Assert.assertEquals("id", transactionResponse.getTransactionId());
    }
    @Test
    ...
    @Test public void orderIdTest(){
        transactionResponse.setOrderId("id");
        Assert.assertEquals("id", transactionResponse.getOrderId());
