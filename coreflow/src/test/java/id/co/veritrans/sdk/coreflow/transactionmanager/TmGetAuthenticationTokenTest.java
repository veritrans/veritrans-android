...
public class TmGetAuthenticationTokenTest extends APIClientMain {
    ...
    public void testGetAuthenticationTokenSuccess(){
        ...
        eventBustImplementSample.getAuthenticationToken(merchantRestAPI);

        Mockito.verify(merchantRestAPI, Mockito.times(1)).getAuthenticationToken(callbackArgumentCaptor.capture());
