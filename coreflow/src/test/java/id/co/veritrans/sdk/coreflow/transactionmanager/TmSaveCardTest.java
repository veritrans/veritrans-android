...
public class TmSaveCardTest extends APIClientMain{
    ...
    @Captor
    private ArgumentCaptor<Callback<SaveCardResponse>> responseCallbackCaptor;
    @Captor
    ...
    public void testPaymentGetCardsCardSuccess_whenResponseNotNull() throws Exception {
        ...
        Mockito.verify(merchantRestAPIMock).saveCard(xauthCaptor.capture(), requestCaptor.capture(), responseCallbackCaptor.capture());
    ...
    public void testPaymentSaveCardCardsCardSuccess_whenResponseNull() throws Exception {
        ...
        responseCallbackCaptor.getValue().success(saveCardResponse, retrofitResponse);
        Mockito.verify(busCollaborator, Mockito.times(1)).onGeneralErrorEvent();
    }

    @Test
    public void testPaymentSaveCardError() throws Exception {
        SaveCardRequest request = new SaveCardRequest();
