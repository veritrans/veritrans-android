...
public class StorageDataHandler {
     ...
     * <p> To read data use {@link #readObject(Context, String)} <p>
     *
     * @param context application context.
     * @param key     file name.
     * @param object  object to store.
     * @throws java.io.FileNotFoundException Thrown when a file specified by a file cannot be found.
     * @throws IOException           Thrown when a failed to write into file.
     */
     ...
     * <p> To write data use {@link #writeObject(Context, String, Object)} .<p>
     *
     * @param context application context.
     * @param key     file name.
     ...
     * @throws IOException           Thrown when a failed to read from file.
     */
