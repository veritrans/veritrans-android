...
public class AlfamartStatusActivity extends BasePaymentActivity {
    ...
    private final String PAGE_NAME = "Alfamart Payment Code";
    private final String BUTTON_CONFIRM_NAME = "Done Alfamart";
    private final String TAG = AlfamartStatusActivity.class.getSimpleName();
    ...
    private void initActionButton() {
        ...
        buttonCopyVa.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SdkUIFlowUtil.showToast(AlfamartStatusActivity.this, copySuccess ? getString(R.string.copied_to_clipboard) : getString(R.string.failed_to_copy));
            }
        });
    ...
    private void bindData() {
        ...
        buttonFinish.setText(getString(R.string.complete_payment_alfamart));
        buttonFinish.setTextBold();
        textTitle.setText(getString(R.string.alfamart));
