...
import com.midtrans.sdk.uikit.widgets.swipeadapter.ViewAdapter;
...
public class SwipeToDismissTouchListener<SomeCollectionView extends ViewAdapter> implements
     ...
     *
     * @param dismissDelayMillis The delay between onPendingDismiss and onDismiss calls, in
     *                           milliseconds.
     */
     ...
     * to this listener. This will ensure that this {@link SwipeToDismissTouchListener} is paused
     * during list view scrolling.</p>
     *
    ...
    public interface DismissCallbacks<SomeCollectionView extends ViewAdapter> {
         ...
         * Do NOT remove the list item yet, that should be done in {@link #onDismiss(ViewAdapter,
         * int)} This may also be called immediately before and item is completely dismissed.
         *
        ...
        /**
         * Called when the item is completely dismissed and removed from the list, after the undo
         * layout is hidden.
         *
         * @param recyclerView The originating {@link android.support.v7.widget.RecyclerView}.
         * @param position     The position of the dismissed item.
