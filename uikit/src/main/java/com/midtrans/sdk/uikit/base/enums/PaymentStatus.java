...
import static com.midtrans.sdk.uikit.base.enums.PaymentStatus.STATUS_CANCEL;
...
@StringDef({STATUS_SUCCESS, STATUS_PENDING, STATUS_INVALID, STATUS_FAILED, STATUS_CANCEL})
