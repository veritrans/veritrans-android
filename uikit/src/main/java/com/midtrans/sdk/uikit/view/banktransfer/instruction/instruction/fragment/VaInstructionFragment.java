...
public abstract class VaInstructionFragment extends Fragment implements View.OnClickListener {
    ...
    public static final String MERCHANT_INFORMATION = "merchant.info";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            PaymentInfoResponse paymentInfoResponse = (PaymentInfoResponse) getArguments().getSerializable(MERCHANT_INFORMATION);
            String otherVaProcessor = paymentInfoResponse.getMerchantData().getPreference().getOtherVaProcessor();
        ...
        if (layoutId == R.layout.fragment_payment_instruction_bank_transfer_alto && !isUsingPermata && !(this instanceof InstructionVaPermataFragment)) {
            layoutId = R.layout.fragment_payment_instruction_bank_transfer_alto_bni;
            isUsingPermata = !isUsingPermata;
        }
        View view = inflater.inflate(layoutId, container, false);

        if (!isUsingPermata) {
            ImageView bankCode = view.findViewById(R.id.instruction_bank_code_image);
            DefaultTextView bankCodeInstruction = view.findViewById(R.id.instruction_bank_code_text);
            if (layoutId == R.layout.fragment_payment_instruction_bank_transfer_atm_bersama) {
            ...
            } else if (layoutId == R.layout.fragment_payment_instruction_bank_transfer_prima) {
                bankCode.setImageResource(R.drawable.instruction_prima_4_bni);
                bankCodeInstruction.setText(R.string.instruction_prima4_bni);
            }
        }

        instructionLayout = view.findViewById(R.id.instruction_layout);
        instructionToggle = view.findViewById(R.id.instruction_toggle);
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            Logger.debug("The activity needs to implement interface first.");
        }
    }
